...
/*
 * Cria as arestas da Fase I. Duas antenas sao elegiveis quando possuem o mesmo
 * MCC, operadora e area e a distancia entre elas e menor ou igual a soma dos
 * alcances. Cada antena e ligada somente a elegivel mais proxima.
 */
